        ...
        <header className=''>
            ...
            <div id="header-main" className="container ">
                ...
                <nav className="navbar navbar-expand-lg ">
                    <div className="container-fluid px-sm-1 px-md-0 navbar-container ">
                        <button
                            ...
                            <div className="btn-group" id="cart-block">
                                ...
                                <div className="dropdown-menu dropdown-menu-end shoppingcart-box">
                                    {getdata.length ? (
                                        ...
                                        <div className="cart_details" style={{ padding: 10 }}>
                                        ...
                                        >
                                            ...
                                            />
                                            <p className='mt-5' style={{ fontSize: 22 }}>Your cart is empty!</p>
